        ...
        <div className="container">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in [animation-delay:300ms] opacity-0">
              <Button size="lg" className="btn-gradient text-primary-foreground border-0 gap-2 px-8 h-12 text-base font-semibold shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 transition-all">
                <Upload className="h-5 w-5" />
                Select PDF File
              </Button>
              <Button variant="outline" size="lg" className="gap-2 h-12 text-base font-medium">
                See All Tools
